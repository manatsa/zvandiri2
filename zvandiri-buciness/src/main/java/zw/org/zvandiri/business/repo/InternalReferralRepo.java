 ...
 */
public interface InternalReferralRepo extends AbstractNameDescRepo<InternalReferral, String> {
    
    @Query("from InternalReferral i left join fetch i.createdBy left join fetch i.modifiedBy where i.active=:active")
