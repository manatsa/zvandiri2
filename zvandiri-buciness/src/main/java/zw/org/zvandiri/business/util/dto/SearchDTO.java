...
public class SearchDTO implements Serializable {
    ...
    public Boolean getSearch(SearchDTO dto) {
        if ((dto.getStatuses() != null && !dto.getStatuses().isEmpty()) || dto.getProvince() != null || dto.getDistrict() != null
                ...
                || dto.getResult() != null || dto.getTbTreatmentStatus() != null || dto.getTbTreatmentOutcome() != null || dto.getUserLevel() != null) {
            return Boolean.TRUE;
        }
    ...
    public SearchDTO getInstance(SearchDTO dto) {
        return new SearchDTO(dto.getPeriod(), dto.getProvince(),
                dto.getDistrict(), dto.getPrimaryClinic(),
                dto.getSupportGroup(),
                dto.getStartDate(), dto.getEndDate(),
                dto.getGender(), dto.getAgeGroup(),
                dto.getPeriodType(), dto.getYearPeriod(),
                dto.getHalfYearPeriod(), dto.getQuarterPeriod(),
                dto.getLevelOfCare(), dto.getStatus(),
                dto.getSupportGroupDistrict(),
                dto.getCareLevel(),
                dto.getCrossTabOptions(),
                dto.getReferralStatus(),
                ...
                dto.getTbTreatmentStatus(), dto.getTbTreatmentOutcome(), dto.getUserLevel());
    }
}
